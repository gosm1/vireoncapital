'use client'
import { ArrowRight, CheckCircle, Zap, Phone } from 'lucide-react';
...
export default function BeautifulCTA() {
  ...
  return (
    <section className="py-10 pb-8 bg-gradient-to-br from-background via-muted/20 to-secondary/30" id="cta">
      <div className="mx-6 pt-2 pb-16 ">
        <div className="relative">
          ...
          <div className={cn(
            ...
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,hsl(var(--primary)/0.08)_0%,transparent_50%)]"></div>
            ...
            <div className="relative z-10 mb-6">
              <div className="bg-primary/10 text-black ring-primary/30 relative mx-auto w-fit rounded-full px-6 py-3 text-sm font-medium ring backdrop-blur-sm">
                ...
                <span className="from-primary/0 via-primary to-primary/0 absolute -bottom-px left-1/2 h-px w-3/5 -translate-x-1/2 bg-gradient-to-r opacity-80"></span>
                <span className="absolute inset-0 bg-[radial-gradient(30%_40%_at_50%_100%,hsl(var(--primary)/0.2)_0%,transparent_100%)]"></span>
              </div>
            </div>
            ...
            <p className="  text-muted-foreground mt-3  mb-8 max-w-3xl mx-auto">
              Join successful coaches who've transformed their lead generation with our proven LQ-SC system
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-10">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center gap-2 text-foreground/80 text-sm sm:text-base">
            ...
            <span className="from-primary/0 via-primary/60 to-primary/0 absolute -bottom-px left-1/2 h-px w-4/5 -translate-x-1/2 bg-gradient-to-r"></span>
          </div>

          {/* Floating decorative cards */}
          <div className="absolute -top-4 -left-4 w-20 h-20 bg-primary/10 rounded-2xl rotate-12 blur-sm opacity-60 hidden lg:block"></div>
          <div className="absolute -bottom-4 -right-4 w-16 h-16 bg-secondary/20 rounded-xl -rotate-12 blur-sm opacity-60 hidden lg:block"></div>
        </div>
      </div>
    </section>
  );
